...
<%Rol roles = (Rol)request.getAttribute("roles"); %>
...
<body>
	...
	<div class="jumbotron boxlogin">
		<form action="/roles/edit?id=<%=roles.getId() %>" method="post">

			<label>Edite rol</label> <input type="text" name="nombre"
				placeholder="Edite el nombre" value="<%=roles.getNombre() %>"
				required class="form-control"> <label>Edite su
				estado</label><br> <input type="radio" name="estado" id="true"
				value="true" checked> <label for="true">True</label> <input
				type="radio" name="estado" id="false" value="false"> <label
				for="false">False</label><br> <input type="submit"
				value="Editar" name="Enviar">
