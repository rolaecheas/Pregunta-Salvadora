		...
		<div align=center width=100%>
			...
			<%} else { %>
				...
				<tr>
						...
						<td><%=res.getFecha() %></td>
					  <td >
                	<a href="/resources/view?id=<%=res.getId() %>">Ver</a>
                	<a href="/resources/edit?id=<%=res.getId() %>">Editar</a>
                	<a href="/resources/delete?id=<%=res.getId() %>">Borrar</a>
                </td>     
					</tr>
				<%} %>
				</table>
