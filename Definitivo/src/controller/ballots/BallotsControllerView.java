...
public class BallotsControllerView extends HttpServlet{
			...
			if(uSearch.isEmpty()){
				...
				if(rSearch.isEmpty()){
					...
					if(aSearch.isEmpty()){
						...
						RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/WEB-INF/Views/Ballots/view.jsp");
						dispatcher.forward(request, response);
					}
				}
			}
