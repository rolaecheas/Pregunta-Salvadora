...
public class BallotsControllerIndex extends HttpServlet{
			...
			if(uSearch.isEmpty()){
				...
				if(rSearch.isEmpty()){
					...
					if(aSearch.isEmpty()){
						...
						List<Ballot> ballots = (List<Ballot>)pm.newQuery(query4).execute();
						pm.close();
						request.setAttribute("ballots", ballots);
						RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/WEB-INF/Views/Ballots/index.jsp");
						dispatcher.forward(request, response);
					}
				}
			}
